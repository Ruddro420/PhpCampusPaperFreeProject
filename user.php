...
<nav style="background:#1A2127; color:#fff;" class="navbar navbar-expand-lg">
  <div class="container">
    <a class="navbar-brand" href="user.php">Computer Science & Engineering</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="https://laughing-ritchie-b79a85.netlify.app/">Assingment Generator</a>
        </li>
        <li class="nav-item">
      ...
      <ul class="navbar-nav">
        <li class="nav-item dropdown">
          ...
          <ul style="padding:15px !important;" class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
...
<div class="container mt-5">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12 mt-3">
      <div class="card">
        <div class="card-body">
        <h3 style="color:#fff; text-align:center;">Courses Status</h3>
...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($link , "SELECT * FROM `course` WHERE `semester` = '$semester' and `session` = '$session';");
  ...
  <!--Search Style Start-->
<div id="scrool_mbl" class="container mt-5 mb-5">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12">
      <div class="card">
        ...
        <thead>
    <tr>
      <th scope="col">Course Tittle</th>
      <th scope="col">Course Code</th>
      <th scope="col">Course Teacher</th>
    </tr>
  </thead>

<tbody style="border:3px solid #19D5BA color:#fff;" class="text-center shadow text-white p-5">
<?php

$inv_data = mysqli_query($link, "SELECT * FROM `course` WHERE `semester` = '$semester' and `session` = '$session';");
...
while($row = mysqli_fetch_assoc($inv_data)){?>
  ...
  <tr>
    <td><?php 
    $uppercase = strtoupper($row['course_tittle']);
    echo $uppercase?></td>

    <td><?php 

    $uppercase = strtoupper($row['course_code']);
    echo $uppercase ?></td>

    <td><?php

    $uppercase = strtoupper($row['course_teacher']);
    echo $uppercase?></td>
...
if(isset($_POST['submit'])){
  ...
  <!--Search Style Start-->
<div id="scrool_dsk" class="container mt-5 mb-5">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12">
      <div class="card">
        <div class="card-body">
