...
<div class="container mt-3 mb-3">
  <div class="row">
    <div class="col">
      <div class="card">
        <div class="card-body">
        <h3 style="color:#fff; text-align:center;">Routine Status</h3>
...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($link , "SELECT * FROM `routine_upload` WHERE `semester` = '$semester' and `session` = '$session';");
...
$inv_data = mysqli_query($link, "SELECT * FROM `routine_upload` WHERE `semester` = '$semester' and `session` = '$session';");
