...
<div class="container">
  <div style="background:#1A2127;width: 60%;margin: auto; margin-top:70px; margin-bottom:110px;" class="row shadow">
    ...
    <div style="margin:0px;" class="row lg_mt">
        <div class="col">
        <h1 style="color:#19D5BA; text-align:center;">Final Result Upload</h1>
...
$sql = "INSERT INTO `final_pdf`(`semester`, `session`, `pdf`) VALUES ('$semester','$session','$pdf')";
...
?>
 ...
 <input style="color:#19D5BA; border:1px solid #19D5BA; text-align:center;padding-left:40px; padding-right:40px;"  class="btn" type="submit" name="submit" value="Final Result Upload"> <br> <br>
 </div>
</form>
