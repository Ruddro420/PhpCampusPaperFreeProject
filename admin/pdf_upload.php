...
<div class="container">
  <div style="background:#1A2127;width: 60%;margin: auto; margin-top:70px;" class="row shadow">
    ...
    <div style="margin:0px;" class="row lg_mt">
        <div class="col">
        <h1 style="color:#19D5BA; text-align:center;">Syllabus Upload</h1>
...
<select required name="session" style="color:#979797;" class="form-select" aria-label="Default select example">
  ...
  <div class="form-group">
    <label style="color:#E5E4E4;" for="StudentID">Syllabus Upload</label>
...
$sql = "INSERT INTO `syllabus_pdf`(`semester`, `session`, `pdf`) VALUES ('$semester','$session','$pdf')";
...
?>
 ...
 <input style="color:#19D5BA; border:1px solid #19D5BA; text-align:center;padding-left:40px; padding-right:40px;"  class="btn" type="submit" name="submit" value="Upload Syllabus"> <br> <br>
 </div>
</form>
