...
<div class="container">
  <div style="background:#1A2127;width: 60%;margin: auto; margin-top:70px; margin-bottom:110px;" class="row shadow">
    ...
    <div style="margin:0px;" class="row lg_mt">
        <div class="col">
        <h1 style="color:#19D5BA; text-align:center;">Previous Question Upload</h1>
...
<select required name="session" style="color:#979797;" class="form-select" aria-label="Default select example">
  ...
  <div class="form-group">
    <label style="color:#E5E4E4;" for="StudentID">Final Result Upload</label>
...
$sql = "INSERT INTO `prv_qs_upload`(`semester`, `session`, `pdf`) VALUES ('$semester','$session','$pdf')";
...
?>
 ...
 <input style="color:#19D5BA; border:1px solid #19D5BA; text-align:center;padding-left:40px; padding-right:40px;"  class="btn" type="submit" name="submit" value="Previous Question Upload"> <br> <br>
 </div>
</form>
