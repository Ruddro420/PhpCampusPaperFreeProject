...
<div class="container">
  <div style="background:#1A2127;width: 60%;margin: auto; margin-top:70px; margin-bottom:110px;" class="row shadow">
    ...
    <div style="margin:0px;" class="row lg_mt">
        <div class="col">
        <h1 style="color:#19D5BA; text-align:center;">Course Status Upload</h1>
...
<select required name="session" style="color:#979797;" class="form-select" aria-label="Default select example">
  ...
  <div class="form-group">
<label style="color:#E5E4E4;" for="StudentID">Course Code</label>
    <input placeholder="ex: CSE 1021"  type="text" class="form-control btn-lg" id="exampleInputEmail1" aria-describedby="emailHelp" name="c_code" value ="<?php if(isset($first_name)) echo $first_name ?>" required>
    <br>
  </div>
...
<select name="course" style="color:#979797;" class="form-select" aria-label="Default select example" required>
  ...
  <div class="form-group">
<label style="color:#E5E4E4;" for="StudentID">Course Teacher</label>
    <input placeholder="ex: Mizanur Rahman"  type="text" class="form-control btn-lg" id="exampleInputEmail1" aria-describedby="emailHelp" name="c_teacher" value ="<?php if(isset($first_name)) echo $first_name ?>" required>
    <br>
  </div>
...
$sql = "INSERT INTO `course`(`course_tittle`, `course_code`, `course_teacher`, `session`, `semester`) VALUES ('$course','$c_code','$c_teacher','$session','$semester')";
