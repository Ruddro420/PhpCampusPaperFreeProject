...
<div class="container mt-5">
  <div class="row">
    <div class="col">
      <div class="card">
        <div class="">
        <h3 style="color:#fff; text-align:center;">Notice Status</h3>
        <!--Start Form Function-->
...
//Main Condition
  ...
  $result = mysqli_query($link , "SELECT * FROM `notice_upload`");
...
$inv_data = mysqli_query($link , "SELECT * FROM `notice_upload`");
...
{?>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingOne<?php echo $row['id'] ?>">
      ...
      <b>Upload Date : </b> <span style="margin-right:20px;" ><?php echo $row['date_time'] ?></span> 
      </button>
    </h2>
