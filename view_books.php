...
<div class="container mt-5">
  <div class="row">
    <div class="col">
      <div class="card">
        <div class="card-body">
        <h3 style="color:#fff; text-align:center;">Books & Documents Status</h3>
...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($link , "SELECT * FROM `book_upload` WHERE `course_name` = '$course';");
  ...
  <!--Search Style Start-->
<div class="container">
  <div style="display:block; margin-top:20px;" class="row">
    <div class="col">
      <div class="">
        <div class="">
        <form  method="post">
...
$inv_data = mysqli_query($link , "SELECT * FROM `book_upload` WHERE `course_name` = '$course' ;");
...
{?>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingOne<?php echo $row['id'] ?>">
      ...
      <b></b> <span style="margin-right:20px;" ><?php echo $row['course_name'] ?></span> 
      </button>
    </h2>
    <div id="flush-collapseOne<?php echo $row['id'] ?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      ...
      <a style="color:black; font-weight:600;" href="books_pdf/<?php echo $row['pdf'] ?>" >Download Here</a>
