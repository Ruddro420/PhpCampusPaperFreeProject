...
<div class="container mt-5">
  <div class="row">
    <div class="col">
      <div class="card">
        <div class="">
        <h3 style="color:#fff; text-align:center;">Previous Question</h3>
        <!--Start Form Function-->
...
//Main Condition
  ...
  $result = mysqli_query($link , "SELECT * FROM `prv_qs_upload`");
...
$inv_data = mysqli_query($link , "SELECT * FROM `prv_qs_upload`");
...
{?>
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseOne<?php echo $row['id'] ?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      ...
      <a style="color:black; font-weight:600;" href="admin/prv_qs/<?php echo $row['pdf'] ?>" >Download Here</a>
      </div>
    </div>
  </div>
</div>
