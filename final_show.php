...
<div class="container mt-5">
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-12 mt-3">
      <div class="card">
        <div class="card-body">
        <h3 style="color:#fff; text-align:center;">Final Status</h3>
...
if(isset($_POST['submit'])){
  ...
  $result = mysqli_query($link , "SELECT * FROM `final_pdf` WHERE `semester` = '$semester' and `session` = '$session';");
...
$inv_data = mysqli_query($link, "SELECT * FROM `final_pdf` WHERE `semester` = '$semester' and `session` = '$session';");
